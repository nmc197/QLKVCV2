...
namespace QuanLyKVC.Controllers
{
    ...
    {
        IQuyenRepository repository;
        public QuyenController(IQuyenRepository _repository)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody]Quyen model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody]Quyen model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody]Quyen model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]Quyen model)
        {
            int result = 0;

            if (!(model.MaQuyen != null))
            {
                return BadRequest();
            }
            ...
            try
            {
                ...
                result = await repository.DeletePermanently(model.MaQuyen);
                if (result == 0)
                {
                    return NotFound();
                }
        ...
        {
            int result = repository.CountQuyen();
            return result;
        }
    }
}
