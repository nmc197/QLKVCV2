...
namespace QuanLyKVC.Controllers
{
    ...
    public class HoaDonController : ControllerBase
    {
        ...
        public HoaDonController(IHoaDonRepository _repository)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody]Hoadon model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody]Hoadon model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody]Hoadon model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]Hoadon model)
        {
            int result = 0;
        ...
        {
            int result = repository.CountHoaDon();
            return result;
        }
    }
}
