...
namespace Novatic.Controllers
{
    ...
    {
        IVeRepository repository;
        public VeController(IVeRepository _repository)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody]Ve model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody]Ve model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody]Ve model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]Ve model)
        {
            int result = 0;
            ...
            try
            {
                ...
                result = await repository.DeletePermanently(model.MaVe);
                if (result == 0)
                {
                    return NotFound();
                }
