...
namespace QuanLyKVC.Controllers
{
    ...
    public class NguoiDungController : ControllerBase
    {
        ...
        public NguoiDungController(INguoiDungRepository _repository)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody]Nguoidung model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody]Nguoidung model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody]Nguoidung model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]Nguoidung model)
        {
            int result = 0;
            ...
            try
            {
                ...
                result = await repository.DeletePermanently(model.MaNd);
                if (result == 0)
                {
                    return NotFound();
                }
        ...
        {
            int result = repository.CountNguoiDung();
            return result;
        }
    }
}
