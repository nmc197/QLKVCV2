...
namespace QuanLyKVC.Controllers
{
    ...
    public class ChiTietHoaDonController : ControllerBase
    {
        ...
        public ChiTietHoaDonController(IChiTietHoaDonRepository _repository)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody]Chitiethoadon model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody]Chitiethoadon model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody]Chitiethoadon model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]Chitiethoadon model)
        {
            int result = 0;
            ...
            try
            {
                ...
                result = await repository.DeletePermanently(model.MaHd);
                if (result == 0)
                {
                    return NotFound();
                }
        ...
        {
            int result = repository.CountChiTietHoaDon();
            return result;
        }
    }
}
