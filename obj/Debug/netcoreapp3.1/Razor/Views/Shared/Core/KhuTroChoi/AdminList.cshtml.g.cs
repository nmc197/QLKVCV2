#pragma checksum "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\KhuTroChoi\AdminList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "96723ecfbb513192a082eb8c43ac0acf62602131"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared_Core_KhuTroChoi_AdminList), @"mvc.1.0.view", @"/Views/Shared/Core/KhuTroChoi/AdminList.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"96723ecfbb513192a082eb8c43ac0acf62602131", @"/Views/Shared/Core/KhuTroChoi/AdminList.cshtml")]
    ...
    public class Views_Shared_Core_KhuTroChoi_AdminList : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n    \r\n");
#nullable restore
#line 3 "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\KhuTroChoi\AdminList.cshtml"
      
        ViewData["Title"] = "Khu trò chơi";
...
#nullable disable
    ...
    <div class=""page-header card"">
        <div class=""col"">
            <div class=""page-header-title"">
                ...
                <div class=""d-inline"">
                    <h3 class=""tableTitle"">Khu trò chơi</h3>
                </div>
            </div>
                    ...
                    <div class=""card"">
                        <div class=""card-block novaticContainer"">
                            <div class=""dt-responsive table-responsive"">
                                ...
                                <table id=""tableData"" class=""table t");
                                    ...
                                    <div class=""modal-dialog modal-lg"">
                                        <div class=""modal-content"">
                                            ...
                                            <div class=""modal-body"">
                                                ...
                                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "96723ecfbb513192a082eb8c43ac0acf626021317990", async() => {
                WriteLiteral(@"

                                                    <!-- <div class=""form-group"">
                                                                        <label for="""">Apply type Id</label>
                                                                        <input type=""text"" class=""form-control""
                                                                            id=""KhuTroChoiId"" required readonly
                                                                            placeholder="""">
                                                                    </div>
     ...
     ");
                ...
                WriteLiteral(@"        <input type='text'
                                                                    ...
                                                                    <div class='form-group' style="""">
                                                                        ...
                                                                        <input type='text' class='form-control'
                                                                            id='KhuTroChoiActive' readonly
                                                                            placeholder=''>
                                                                    </div>
           ");
                WriteLiteral("                                                         -->\r\n                                                     <div class=\"form-group  col-sm-4\"   >\r\n                    <label");
                BeginWriteAttribute("for", " for=\"", 6393, "\"", 6399, 0);
                EndWriteAttribute();
                WriteLiteral(">giaVeTreEm</label>\r\n                    <input type=\"number\" class=\"form-control input-giaVeTreEm\" value=\"0\"\r\n                        id=\"KhuTroChoiGiaVeTreEm\"");
                BeginWriteAttribute("placeholder", "   \r\n                        placeholder=\"", 6560, "\"", 6602, 0);
                EndWriteAttribute();
                WriteLiteral(">\r\n                </div> <div class=\"form-group  col-sm-4\"   >\r\n                    <label");
                BeginWriteAttribute("for", " for=\"", 6694, "\"", 6700, 0);
                EndWriteAttribute();
                WriteLiteral(">GiaVeNguoiLon</label>\r\n                    <input type=\"number\" class=\"form-control input-GiaVeNguoiLon\" value=\"0\"\r\n                        id=\"KhuTroChoiGiaVeNguoiLon\"");
                BeginWriteAttribute("placeholder", "   \r\n                        placeholder=\"", 6870, "\"", 6912, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                </div>
    ...
    <script>
    ");
            WriteLiteral(@"    var hiddenItem = [""maKhu"",""maNV""];
        var showItem = [""tenKhu"",""gioiTinh"",""giaVeTreEm"",""GiaVeNguoiLon""];
        var dataSource = [];
        ...
        function loadData() {
           ...
           ");
            WriteLiteral(@"                         else {
                        ...
                        // $(""#tableData #dummyRow"").after(""<tr id='row""+item.id+""' >"" + rowCont");
            WriteLiteral(@"ent + ""</tr>"");
                    });
        ...
        function editItem(id) {
            ...
            let obj = getItemById(id);
            		$(""#KhuTroChoiMaKhu"").val(id > 0 ? obj.maKhu : """");
		$(""#KhuTroChoiTenKhu"").val(");
            WriteLiteral(@"id > 0 ? obj.tenKhu : """");
		$(""#KhuTroChoiGioiTinh"").val(id > 0 ? obj.gioiTinh : """");
		$(""#KhuTroChoiMaNV"").val(id > 0 ? obj.maNV : """");
		$(""#KhuTroChoiGiaVeTreEm"").val(id > 0 ? obj.giaVeTreEm : """");
		$(""#KhuTroChoiGiaVeNguoiLon"").val(id > 0 ? obj.GiaVeNguoiLon : """");

            // $(""#KhuTroChoiId"").val(id > 0 ? obj.id : """");
            // $(""#KhuTroChoiName"").val(id > 0 ? obj.name : """");
            // $(""#KhuTroChoiDescription"").val(id > 0 ? obj.description : """");
            // $(""#KhuTroChoiCreatedTime"").val(id > 0 ? obj.createdTime : """");
            // $(""#KhuTroChoiActive"").val(id > 0 ? obj.active : """");

            if(id==0){
                $(""#KhuTroChoiActive"").val(1);
                $(""#KhuTroChoiCreatedTime"").val(new Date().toISOString().replace(/T/, ' ').replace(/\..+/, ''));
            }
            else{
                // correcting data
        ...
        function updateItem(id) {
            ...
            // ""id"": $(""#KhuTroChoiId"").val(),
            // ""name"": $(""#KhuTroChoiName"").val(),
            // ""description"": $(""#KhuTroChoiDescription"").val(),
            // ""createdTime"": $(""#KhuTroChoiCreatedTime"").val(),
            // ""active"": $(""#KhuTroChoiActive"").val()
            var updatingObj = {
                		""maKhu"": $(""#KhuTroChoiMaKhu"").val(),
		""tenKhu"": $(""#KhuTroChoiTenKhu"").val(),
		""gioiTinh"": $(""#KhuTroChoiGioiTinh"").val(),
		""maNV"": $(""#KhuTroChoiMaNV"").val(),
		""giaVeTreEm"": $(""#KhuTroChoiGiaVeTreEm"").val(),
		""GiaVeNguoiLon"": $(""#KhuTroChoiGiaVeNguoiLon"").val(),
                ...
                if (result.value) {
                    ...
                    if (id > 0) {
                        $.ajax({
                            ...
                            success: function (responseData) {
                                // debugger;
                                if (responseData.status == 200 && responseData.message === ""S");
            WriteLiteral(@"UCCESS"") {
                                    Swal.fire(
                                        'Updated!',
                            ...
                            success: function (responseData) {
                                ...
                                if (responseData.status == 201 && responseData.message === ""CREATED"") {
                                    Swal.fire(
                                        'Created!',
                                   ");
            WriteLiteral(@"     'New item has been successfully created!',
                                        'success'
                                    );
                        ...
                        success: function (responseData) {
                            ...
                            if (responseData.status == 200 && responseData.message === ""SUCCESS"") {
                                Swal.fire(
                                    'Deleted!',
                                    'Item ' + ");
            WriteLiteral(@"obj.name + ' has been deleted.',
                                    'success'
                                );
        ...
        function updateTable(id,obj,action) {
                ...
                $("".row""+id+""-column"").each(function(){
                    ...
                    for (var key in obj) {
                        if (key === propertyName && obj.hasOwnProperty(key)) {
                            if(key === ""photo""){
                                $(thi");
            WriteLiteral(@"s).children().attr(""src"",obj[key]);
                            }
                            else{
            ...
            //     // debugger;
            //     var KhuTroChoiId = parseInt($(this).attr('class').replace('row','').replace('-column',''));
            //     var KhuTroChoiObj = getItemById(KhuTroChoiId);
            //     var NO_FKId = parseInt(KhuTroChoiObj.NO_FKId);
            //     var NO_FKObj = NO_FKData.find(item => parseInt(item.id) === NO_FKId);
            //     $(this).text(NO_FKObj.name)");
            WriteLiteral(@";
            //     // console.log('FK updated for Staff '+KhuTroChoiId);
            // });
