#pragma checksum "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\Quyen\AdminList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4398455d0a0f9e3ee309474ae77f1c9d0f9f737f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared_Core_Quyen_AdminList), @"mvc.1.0.view", @"/Views/Shared/Core/Quyen/AdminList.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4398455d0a0f9e3ee309474ae77f1c9d0f9f737f", @"/Views/Shared/Core/Quyen/AdminList.cshtml")]
    ...
    public class Views_Shared_Core_Quyen_AdminList : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n    \r\n");
#nullable restore
#line 3 "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\Quyen\AdminList.cshtml"
...
#nullable disable
                    ...
                    <div class=""card"">
                        <div class=""card-block novaticContainer"">
                            <div class=""dt-responsive table-responsive"">
                                ...
                                <table id=""tableData"" class=""table table-ho");
            WriteLiteral(@"ver"">
                                    <thead>
                                        <tr>
                                            <th>Index</th>
                                    ...
                                    <div class=""modal-dialog modal-lg"">
                                        <div class=""modal-content"">
                                            ...
                                            <div class=""modal-body"">
                                                ...
                                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4398455d0a0f9e3ee309474ae77f1c9d0f9f737f7888", async() => {
                WriteLiteral(@"

                                                    <!-- <div class=""form-group"">
                                                                        <label for="""">Apply type Id</label>
                                                                        <input type=""text"" class=""form-control""
                                                                            id=""QuyenId"" required readonly
                                                                            placeholder="""">
                                                                    </div>
    ...
    <script>
    ");
            WriteLiteral(@"    var hiddenItem = [""maQuyen""];
        var showItem = [""tenQuyen"",""mieuTa"",""kyHieuQuyen""];
        var dataSource = [];
      ...
      ");
        ...
        function editItem(id) {
            ...
            let obj = getItemById(id);
            		$(""#QuyenMaQuyen"").val(id > 0 ? obj.maQuyen : """");
		$(""#QuyenTenQuyen"").val(id > 0 ? obj.tenQuyen : """");
");
            WriteLiteral(@"		$(""#QuyenMieuTa"").val(id > 0 ? obj.mieuTa : """");
		$(""#QuyenKyHieuQuyen"").val(id > 0 ? obj.kyHieuQuyen : """");

            // $(""#QuyenId"").val(id > 0 ? obj.id : """");
            // $(""#QuyenName"").val(id > 0 ? obj.name : """");
            // $(""#QuyenDescription"").val(id > 0 ? obj.description : """");
            // $(""#QuyenCreatedTime"").val(id > 0 ? obj.createdTime : """");
            // $(""#QuyenActive"").val(id > 0 ? obj.active : """");

            if(id==0){
                $(""#QuyenActive"").val(1);
                $(""#QuyenCreatedTime"").val(new Date().toISOString().replace(/T/, ' ').replace(/\..+/, ''));
            }
            else{
                // correcting data
        ...
        function updateItem(id) {
            ...
            let obj = getItemById(id);
            let objName ");
            WriteLiteral(@"= id > 0 ? obj.name : "" "";

            validateInputNumber();

            // ""id"": $(""#QuyenId"").val(),
            // ""name"": $(""#QuyenName"").val(),
            // ""description"": $(""#QuyenDescription"").val(),
            // ""createdTime"": $(""#QuyenCreatedTime"").val(),
            // ""active"": $(""#QuyenActive"").val()
            var updatingObj = {
                		""maQuyen"": $(""#QuyenMaQuyen"").val(),
		""tenQuyen"": $(""#QuyenTenQuyen"").val(),
		""mieuTa"": $(""#QuyenMieuTa"").val(),
		""kyHieuQuyen"": $(""#QuyenKyHieuQuyen"").val(),
            ...
            WriteLiteral(@"Yes, confirm!'
                ...
                if (result.value) {
                    ...
                    if (id > 0) {
                        $.ajax({
                            url: systemURL+ ""Quyen/api/update"",
                            type: ""POST"",
            ...
            WriteLiteral(@"  updateTable(id,updatingObj,""update"");
                    ...
                    if (id == 0) {
                        ...
                        updatingObj.createdTi");
            WriteLiteral(@"me = new Date();
                        console.log(updatingObj);
                        $.ajax({
                            url:systemURL + ""Quyen/api/add"",
                            type: ""POST"",
                            contentType: ""application/json"",
                            data: JSON.stringify(updatingObj),
                            success: function (responseData) {
        ...
        function deleteItem(id) {
            ...
            WriteLiteral(@"=> {
                if (result.value) {
                    ...
                    //CALL AJAX TO DELETE
                    $.ajax({
                        url: systemURL + ""Quyen/api/delete"",
                        type: ""POST"",
                        contentType: ""application/json"",
     ...
     ");
        ...
        function updateTable(id,obj,action) {
            ...
            WriteLiteral(@" {
                    ...
                    addedValues.push(""<td style='text-align: center;'><a onclick='deleteItem("" + item.id + """);
            WriteLiteral(@")'><i class='fa fa-trash fa-2x' style='color:#e91e63'></i></a></td>"");
            ...
            /");
            WriteLiteral(@"/ var NO_FKFKUpdateSelector = 'tr';
            // if( !(typeof(id) === 'undefined')) {
            //     NO_FKFKUpdateSelector = '#row'+id;
            // }
            // $('#tableData tbody '+NO_FKFKUpdateSelector+' td[property=NO_FKId]').each(function(){
            //     // debugger;
            //     var QuyenId = parseInt($(this).attr('class').replace('row','').replace('-column',''));
            //     var QuyenObj = getItemById(QuyenId);
            //     var NO_FKId = parseInt(QuyenObj.NO_FKId);
            //     var NO_FKObj = NO_FKData.find(item => parseInt(item.id) === NO_FKId);
            //     $(this).text(NO_FKObj.name);
            //     // console.log('FK updated for Staff '+QuyenId);
            // });
