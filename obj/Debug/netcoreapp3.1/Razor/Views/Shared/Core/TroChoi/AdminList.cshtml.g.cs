#pragma checksum "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\TroChoi\AdminList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6bedac14c072c443e5c2f8ade09101ce2baedaa6"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared_Core_TroChoi_AdminList), @"mvc.1.0.view", @"/Views/Shared/Core/TroChoi/AdminList.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6bedac14c072c443e5c2f8ade09101ce2baedaa6", @"/Views/Shared/Core/TroChoi/AdminList.cshtml")]
    ...
    public class Views_Shared_Core_TroChoi_AdminList : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n    \r\n");
#nullable restore
#line 3 "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\TroChoi\AdminList.cshtml"
      
        ViewData["Title"] = "TROCHOI";
...
#nullable disable
    ...
    <div class=""page-header card"">
        <div class=""col"">
            <div class=""page-header-title"">
                ...
                <div class=""d-inline"">
                    <h3 class=""tableTitle"">TROCHOI</h3>
                </div>
            </div>
                                    ...
                                    <div class=""modal-dialog modal-lg"">
                                        <div class=""modal-content"">
                                            ...
                                            <div class=""modal-body"">
                                                ...
                                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6bedac14c072c443e5c2f8ade09101ce2baedaa67884", async() => {
                WriteLiteral(@"

                                                    <!-- <div class=""form-group"">
                                                                        <label for="""">Apply type Id</label>
                                                                        <input type=""text"" class=""form-control""
                                                                            id=""TroChoiId"" required readonly
                                                                            placeholder="""">
                                                                    </div>
           ...
           ");
                ...
                WriteLiteral(@"input type='text'
                                                                    ...
                                                                    <div class='form-group' style="""">
                                                                        ...
                                                                        <input type='text' class='form-control'
                                                                            id='TroChoiActive' readonly
                                                                            placeholder=''>
                                                                    </div>
                          ");
                WriteLiteral("                                          -->\r\n                                                     <div class=\"form-group  col-sm-4\"   >\r\n                    <label");
                BeginWriteAttribute("for", " for=\"", 6290, "\"", 6296, 0);
                EndWriteAttribute();
                WriteLiteral(">soLuongNguoiChoiMax</label>\r\n                    <input type=\"number\" class=\"form-control input-soLuongNguoiChoiMax\" value=\"0\"\r\n                        id=\"TroChoiSoLuongNguoiChoiMax\"");
                BeginWriteAttribute("placeholder", "   \r\n                        placeholder=\"", 6481, "\"", 6523, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                </div>
    ...
    <script>
    ");
            WriteLiteral(@"    var hiddenItem = [""maTroChoi"",""maNV"",""maKhu""];
        var showItem = [""tenTroChoi"",""soLuongNguoiChoiMax""];
        var dataSource = [];
        ...
        function loadData() {
            ...
            WriteLiteral(@"                    else {
                        ...
                        // $(""#tableData #dummyRow"").after(""<tr id='row""+item.id+""' >"" + rowContent +");
            WriteLiteral(@" ""</tr>"");
                    });
        ...
        function editItem(id) {
            ...
            let obj = getItemById(id);
            		$(""#TroChoiMaTroChoi"").val(id > 0 ? obj.maTroChoi : """");
		$(""#TroChoiTenTroChoi"").val");
            WriteLiteral(@"(id > 0 ? obj.tenTroChoi : """");
		$(""#TroChoiMaNV"").val(id > 0 ? obj.maNV : """");
		$(""#TroChoiSoLuongNguoiChoiMax"").val(id > 0 ? obj.soLuongNguoiChoiMax : """");
		$(""#TroChoiMaKhu"").val(id > 0 ? obj.maKhu : """");

            // $(""#TroChoiId"").val(id > 0 ? obj.id : """");
            // $(""#TroChoiName"").val(id > 0 ? obj.name : """");
            // $(""#TroChoiDescription"").val(id > 0 ? obj.description : """");
            // $(""#TroChoiCreatedTime"").val(id > 0 ? obj.createdTime : """");
            // $(""#TroChoiActive"").val(id > 0 ? obj.active : """");

            if(id==0){
                $(""#TroChoiActive"").val(1);
                $(""#TroChoiCreatedTime"").val(new Date().toISOString().replace(/T/, ' ').replace(/\..+/, ''));
            }
            else{
                // correcting data
        ...
        function updateItem(id) {
            va");
            WriteLiteral(@"r actionName = (id == 0 ? ""Create"" : ""Update"");
            let obj = getItemById(id);
            ...
            // ""id"": $(""#TroChoiId"").val(),
            // ""name"": $(""#TroChoiName"").val(),
            // ""description"": $(""#TroChoiDescription"").val(),
            // ""createdTime"": $(""#TroChoiCreatedTime"").val(),
            // ""active"": $(""#TroChoiActive"").val()
            var updatingObj = {
                		""maTroChoi"": $(""#TroChoiMaTroChoi"").val(),
		""tenTroChoi"": $(""#TroChoiTenTroChoi"").val(),
		""maNV"": $(""#TroChoiMaNV"").val(),
		""soLuongNguoiChoiMax"": $(""#TroChoiSoLuongNguoiChoiMax"").val(),
		""maKhu"": $(""#TroChoiMaKhu"").val(),
                            ...
                            success: function (responseData) {
                                ...
                                if (responseData.status == 200 && responseData.message === ""SUCCESS"") {
                                    Swal.fire(
                                        'Updated!',
                               ");
            WriteLiteral(@"         'Item ' + objName + ' has been successfully updated!',
                                        'success'
                                    );
       ...
       ");
            WriteLiteral(@"                             updatingObj = responseData.data;
                    ...
                    $.ajax({
                        ...
                        success: function (responseData) {
                            ...
                            if (responseData.status == 200 && responseData.message === ""SUCCESS"") {
                                ...
                                u");
            WriteLiteral(@"pdateTable(id,0,""delete"");
                            }
                        },
                        error: function (e) {
                            //console.log(e.message);
        ...
        function updateTable(id,obj,action) {
            ...
            WriteLiteral(@"wContent = """";
                    ...
                    addedValues.push(""<td style='text-align: center;'><a onclick='editItem(");
            WriteLiteral(@""" + item.id + "")'><i class='fa fa-edit fa-2x' style='color:#03a9f4'></i></a></td>"");
            ...
            //     // debugger;
            //     var TroChoiId = parseInt($(this).attr('class').replace('row','').replace('-column',''));
            //     var TroChoiObj = getItemById(TroChoiId);
            //     var NO_FKId = parseInt(TroChoiObj.NO_FKId);
            //     var NO_FKObj = NO_FKData.find(item => parseInt(item.id) === NO_FKId);
            //     $(this).text(NO_FKObj.name);
            //     // console.log('FK updated for Staff '+TroChoiId);
            // });
