#pragma checksum "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\ChiTietHoaDon\AdminList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9c30e5764568493e4df191e262478c462bf6589a"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared_Core_ChiTietHoaDon_AdminList), @"mvc.1.0.view", @"/Views/Shared/Core/ChiTietHoaDon/AdminList.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9c30e5764568493e4df191e262478c462bf6589a", @"/Views/Shared/Core/ChiTietHoaDon/AdminList.cshtml")]
    ...
    public class Views_Shared_Core_ChiTietHoaDon_AdminList : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n    \r\n");
#nullable restore
#line 3 "C:\Users\Cuong\source\repos\QuanLyKVC\QuanLyKVC\Views\Shared\Core\ChiTietHoaDon\AdminList.cshtml"
...
#nullable disable
    ...
    <div class=""page-header card"">
        <div class=""col"">
            <div class=""page-header-title"">
                ...
                <div class=""d-inline"">
                    <h3 class=""tableTitle"">Chi tiết hóa đơn</h3>
                </div>
            </div>
            ...
            WriteLiteral(@"                   <div class=""modal-dialog modal-lg"">
                                        <div class=""modal-content"">
                                            ...
                                            <div class=""modal-body"">
                                                ...
                                                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9c30e5764568493e4df191e262478c462bf6589a7870", async() => {
                WriteLiteral(@"

                                                    <!-- <div class=""form-group"">
                                                                        <label for="""">Apply type Id</label>
                                                                        <input type=""text"" class=""form-control""
                                                                            id=""ChiTietHoaDonId"" required readonly
                                                                            placeholder="""">
                                                                    </div>
                ...
                WriteLiteral(@"                 <input type='text'
                                                                    ...
                                                                    <div class='form-group' style="""">
                                                                        ...
                                                                        <input type='text' class='form-control'
                                                                            id='ChiTietHoaDonActive' readonly
                                                                            placeholder=''>
                                                                    </di");
                WriteLiteral("v>\r\n                                                                    -->\r\n                                                     <div class=\"form-group  col-sm-4\"   >\r\n                    <label");
                BeginWriteAttribute("for", " for=\"", 6270, "\"", 6276, 0);
                EndWriteAttribute();
                WriteLiteral(">soLanSuDungDV</label>\r\n                    <input type=\"number\" class=\"form-control input-soLanSuDungDV\" value=\"0\"\r\n                        id=\"ChiTietHoaDonSoLanSuDungDV\"");
                BeginWriteAttribute("placeholder", "   \r\n                        placeholder=\"", 6449, "\"", 6491, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                </div>
    ...
    <script>
    ");
            WriteLiteral(@"    var hiddenItem = [""maHD"",""maDV""];
        var showItem = [""soLanSuDungDV""];
        var dataSource = [];
        ...
        function loadData() {
            $.ajax({
                url: systemURL+ ""ChiTietHoaDon/api/list"",
                type: ""GET"",
                co");
        ...
        function editItem(id) {
            ...
            let obj = getItemById(id);
            		$(""#ChiTietHoaDonMaHD"").val(id > 0 ? obj.maHD : """");
		$(""#ChiTietHoaDonMaDV"").val(id > 0 ? obj.maDV : """");
		$(");
            WriteLiteral(@"""#ChiTietHoaDonSoLanSuDungDV"").val(id > 0 ? obj.soLanSuDungDV : """");

            // $(""#ChiTietHoaDonId"").val(id > 0 ? obj.id : """");
            // $(""#ChiTietHoaDonName"").val(id > 0 ? obj.name : """");
            // $(""#ChiTietHoaDonDescription"").val(id > 0 ? obj.description : """");
            // $(""#ChiTietHoaDonCreatedTime"").val(id > 0 ? obj.createdTime : """");
            // $(""#ChiTietHoaDonActive"").val(id > 0 ? obj.active : """");

            if(id==0){
                $(""#ChiTietHoaDonActive"").val(1);
                $(""#ChiTietHoaDonCreatedTime"").val(new Date().toISOString().replace(/T/, ' ').replace(/\..+/, ''));
            }
            else{
                // correcting data
        ...
        function updateItem(id) {
            ...
            let obj = getItemById(id);
           ");
            WriteLiteral(@" let objName = id > 0 ? obj.name : "" "";

            validateInputNumber();

            // ""id"": $(""#ChiTietHoaDonId"").val(),
            // ""name"": $(""#ChiTietHoaDonName"").val(),
            // ""description"": $(""#ChiTietHoaDonDescription"").val(),
            // ""createdTime"": $(""#ChiTietHoaDonCreatedTime"").val(),
            // ""active"": $(""#ChiTietHoaDonActive"").val()
            var updatingObj = {
                		""maHD"": $(""#ChiTietHoaDonMaHD"").val(),
		""maDV"": $(""#ChiTietHoaDonMaDV"").val(),
		""soLanSuDungDV"": $(""#ChiTietHoaDonSoLanSuDungDV"").val(),
      ...
      ");
            WriteLiteral(@"          confirmButtonText: 'Yes, confirm!'
            }).then((result) => {
                if (result.value) {
                    $(""#modal-id"").modal('hide');
                    ...
                    if (id > 0) {
                        $.ajax({
                            url: systemURL+ ""ChiTietHoaDon/api/update"",
                            type: ""POST"",
       ...
       ");
            WriteLiteral(@"                 updatingObj.createdTime = new Date();
                        console.log(updatingObj);
                        $.ajax({
                            url:systemURL + ""ChiTietHoaDon/api/add"",
                            type: ""POST"",
                            contentType: ""application/json"",
                            data: JSON.stringify(updatingObj),
                            success: function (responseData) {
                ...
                ");
            WriteLiteral(@"                    updateTable(0,updatingObj,""add"");
                                }
                            },
                            error: function (e) {
                                //console.log(e.message);
        ...
        function deleteItem(id) {
            ...
            Swal.fire({
                ...
                confirmButtonText: 'Y");
            WriteLiteral(@"es, delete it!'
            }).then((result) => {
                if (result.value) {

                    //CALL AJAX TO DELETE
                    $.ajax({
                        url: systemURL + ""ChiTietHoaDon/api/delete"",
                        type: ""POST"",
                        contentType: ""application/json"",
      ...
      ");
        ...
        function updateTable(id,obj,action) {
            ...
            WriteLiteral(@"
                    ...
                    addedValues.push(""<td style='text-");
            WriteLiteral(@"align: center;'><a onclick='deleteItem("" + item.id + "")'><i class='fa fa-trash fa-2x' style='color:#e91e63'></i></a></td>"");
      ...
      ");
            WriteLiteral(@"      //Update columns with foreign key
            ...
            //     // debugger;
            //     var ChiTietHoaDonId = parseInt($(this).attr('class').replace('row','').replace('-column',''));
            //     var ChiTietHoaDonObj = getItemById(ChiTietHoaDonId);
            //     var NO_FKId = parseInt(ChiTietHoaDonObj.NO_FKId);
            //     var NO_FKObj = NO_FKData.find(item => parseInt(item.id) === NO_FKId);
            //     $(this).text(NO_FKObj.name);
            //     // console.log('FK updated for Staff '+ChiTietHoaDonId);
            // });
        ...
        function getItemById(id) {
            const result = dataSource.find(item => parseInt(item.id) =");
            WriteLiteral("== id);\r\n            return result;\r\n        } \r\n\r\n            \r\n    </script>");
        }
